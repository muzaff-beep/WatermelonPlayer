...
dependencies {
    ...
    // Storage Access Framework - PHASE 2
    implementation("androidx.documentfile:documentfile:1.0.1")

    // ML (Global edition only)
    ...
    // Iranian payment (Iran edition only)
    "iranImplementation"(files("libs/zarinpal.aar"))
    "iranImplementation"(files("libs/idpay.aar"))
    
    // Google Play Billing (Global edition only)
    "globalImplementation"("com.android.billingclient:billing:6.2.1")

    // SMB (Global edition only)
